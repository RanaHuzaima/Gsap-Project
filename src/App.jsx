...
const App = () => {
  useEffect(() => {
    ...
    tl.from(".black-card", { opacity: 0, scale: 0.8, delay: 0.5, ease:"circ.inOut" })
      ...
      .to(".black-card, .white-card, .some-white-card", {
        y: -200,
        opacity: 0,
        duration: 1,
      });
    ...
    gsap.fromTo(
      ".logo-img",
      { x: -300, opacity: 0 },
      { x: 0, opacity: 1, duration: 1.5, ease: "elastic.out(1,0.3)", delay: 0.7 }
    );
    gsap.fromTo(
      ".svg",
      { y: 300, opacity: 0 },
      { y: 0, opacity: 1, duration: 1.5, ease: "power2.inOut", delay: 0.7 }
    );
  }, []);
        ...
        <div className="p-[50px] svg">
          <div className="flex items-center">
            ...
            >
              ...
              ></path>
              <path
                d="M18.4934 61.6499C13.4001 60.2394 8.15001 60.8663 3.76191 63.1387C3.2134 63.4521 2.97832 64.1573 3.29176 64.7059C5.8776 68.9372 9.95226 72.2283 15.0456 73.6388C20.1389 75.0492 25.389 74.4224 29.7771 72.15C30.3256 71.8365 30.5606 71.1313 30.2472 70.5828C27.7397 66.4298 23.5867 63.1387 18.4934 61.6499Z"
                fill="currentColor"
              ></path>
              <path
              ...
              ></path>
              <path
                d="M18.885 24.0383C17.5529 18.8666 14.4186 14.7136 10.2655 12.0494C9.71702 11.736 9.01179 11.8927 8.69835 12.4412C6.34759 16.7509 5.564 21.9226 6.81774 27.0943C8.07148 32.266 11.2842 36.419 15.4372 39.0832C15.9857 39.3966 16.691 39.2399 17.0044 38.6914C19.4335 34.3817 20.2171 29.21 18.885 24.0383Z"
                fill="currentColor"
              ></path>
              <path
                d="M33.6944 16.2795C35.1049 11.1862 34.478 5.93614 32.2056 1.54804C31.8922 0.999529 31.187 0.764452 30.6384 1.07789C26.4071 3.66373 23.116 7.73839 21.7055 12.8317C20.2951 17.925 20.9219 23.1751 23.1943 27.5632C23.5078 28.1117 24.213 28.3468 24.7615 28.0333C28.9145 25.5259 32.2056 21.4512 33.6944 16.2795Z"
                fill="currentColor"
              ></path>
            </svg>
      ...
      <div className="absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2">
        <div className="grid grid-cols-3 gap-4 p-3">
          {[...Array(6)].map((_, index) => (
            <div
              key={index}
              className={`card w-[250px] h-[350px] bg-white border-2 border-black rounded-xl flex flex-col justify-between p-3 scale-75 ${
                index % 2 === 0 ? "some-white-card" : "white-card"
              }`}
            >
